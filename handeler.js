jQuery(function() {
    ...
    jQuery.getJSON('editme.json', function(data){
        ...
        if (layout==="logo") {
            ...
            document.getElementById('logotext').innerHTML=`<div class="container" style="padding-top: 20px;"><div class="row"><div class="col-12"><center><img src="${logo}" alt="${name}'s Logo" class="logo"></center></div><div class="col-12"><center><h1 style="padding-top: 10px;">${name}</h1></center></div></div></div>`
        }
